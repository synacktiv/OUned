...
class NTLMSSP_DOMAIN(NTLMSSP):
    ...
    :param verbose: verbosity control of the Netlogon client
    ...
    def __init__(self, UPN=None, *args, timeout=3, ssp=None, verb=True, **kwargs):
    ...
    def _getSessionBaseKey(self, Context, ntlm):
        ...
        client = NetlogonClient(verb=self.verb)
        client.connect(self.DC_IP)
